...
const StarOptions = ({ currentObject, updateAttr }: Props) => {
  ...
  const handleStarPointChange = (value: number | null) => {
    setStarPoint(value);
    updateAttr('numPoints', value);
  };

  const handleStarInnerRadiusChange = (value: number | null) => {
    setInnerRadius(value);
    updateAttr('innerRadius', value);
  };

  const handleStarOuterRadiusChange = (value: number | null) => {
  ...
  return (
    <Space direction={'vertical'} align="start">
      <Space>
        <Typography.Text>꼭지점:</Typography.Text>
        <InputNumber
          type="text"
          name="star-point"
          addonAfter="개"
      ...
      <Space>
        <Typography.Text>내각:</Typography.Text>
        <InputNumber
          type="text"
      ...
      <Space>
        <Typography.Text>외곽:</Typography.Text>
        <InputNumber
          type="text"
